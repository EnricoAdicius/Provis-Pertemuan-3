...
public class program_latihan_3_2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "13", "14", "15" }));
        ...
        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Merah", "Kuning", "Hijau", "Biru" }));
    ...
    private void jComboBox2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox2ActionPerformed
        // TODO add your handling code here:
        if (jComboBox2.getSelectedItem()=="13") {
            jTextArea1.setFont(new Font(jTextArea1.getFont().getName(),jTextArea1.getFont().getStyle(),13));
        }else if(jComboBox2.getSelectedItem()=="14"){
            ...
            jTextArea1.setFont(new Font(jTextArea1.getFont().getName(), jTextArea1.getFont().getStyle(), 15));
        }
    ...
    private void jComboBox3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox3ActionPerformed
        ...
        }else if(jComboBox3.getSelectedItem()=="Kuning"){
